...
- **부분이나 한 원소의 참조**
    ...
    ![indexing](../../img/data_analysis/indexing.png)
...
- **axis 별로 범위를 지정하여 실행**
    ...
    ![slicing](../../img/data_analysis/slicing.png)

> 이미지의 STRIDES ARE ALSO POSSIBLE 은 시험문제로 출제된다..

### 2차원 배열의 축과 슬라이싱  

![2D-array-slicing](../../img/data_analysis/2D-array-slicing.png)


### 슬라이싱 정리

![slicing-sample](../../img/data_analysis/slicing-sample.png)
...
- **특정 순서로 열을 선택**
    ...
    ![fancy-indexing-origin-data-example](../../img/data_analysis/fancy-indexing-origin-data-example.png)

    ![fancy-indexing-example](../../img/data_analysis/fancy-indexing-example.png)

- **배열에 인덱스 배열을 전달하여 요소를 참조하는 방법**  

    ![fancy-indexing-example2](../../img/data_analysis/fancy-indexing-example2.png)
...
- **각각의 색인 튜플에 대응하는 1차원 배열 선택**
    ...
    ![multi-array-indexing-example](../../img/data_analysis/multi-array-indexing-example.png)
...
- **다차원 배열**
    ...
    ![multi-array-transposition-example](../../img/data_analysis/multi-array-transposition-example.png)
...
- **행렬의 인덱스가 바뀌는 변환**
    ...
    ![array-transpose-example](../../img/data_analysis/array-transpose-example.png)
...
- **[numpy.ndarray 객체]의 shape을 변경한 것을 반환**
    ...
    ![array-reshape-example](../../img/data_analysis/array-reshape-example.png)
...
- **두 개의 축 번호를 교환**
    ...
    ![array-swapaxes-painting](../../img/data_analysis/array-swapaxes-painting.png)
...
- **배열의 shape을 1차원 배열로 만드는 메서드**
    ...
    ![array-ravel-example](../../img/data_analysis/array-ravel-example.png)
...
- **교재 p144**
    ...
    ![array-reference-example](../../img/data_analysis/array-reference-example.png)
...
- **배열 메소드**
    ...
    ![array-method-example](../../img/data_analysis/array-method-example.png)
...
- **축 옵션 axis=**
    ...
    ![array-axis-operation-origin-data-example](../../img/data_analysis/array-axis-operation-origin-data-example.png)

    ![array-axis-operation-example](../../img/data_analysis/array-axis-operation-example.png)

    ![array-axis-operation-painting-example](../../img/data_analysis/array-axis-operation-painting-example.png)
