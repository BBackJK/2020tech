...
- **행, 열의 색인을 정렬: sort_index**  
    ...
    ![pandas-dataframe-example32](../../img/data_analysis/200625/pandas-dataframe-example32.png)
...
- **메소드 ``df.sort_values()``**       
    ...
    ![pandas-dataframe-example33](../../img/data_analysis/200625/pandas-dataframe-example33.png)

    ![pandas-dataframe-example34](../../img/data_analysis/200625/pandas-dataframe-example34.png)  
